...
#Defining features
features=['DATE','DAY_WE_DS', 'year','month','day','hour','minute', 'WEEK_END', 'cod_TPER_TEAM','cod_ASS_ASSIGNMENT']
features_train=['DAY_WE_DS', 'year' ,'month','day','hour','minute','WEEK_END', 'cod_TPER_TEAM']
